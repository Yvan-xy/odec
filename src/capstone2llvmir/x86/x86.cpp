        ...
        uint32_t Capstone2LlvmIrTranslatorX86_impl::getAccumulatorRegister(std::size_t size) {
            switch (size) {
                ...
                case 8:
                    return X86_REG_RAX;
                default:
                    throw GenericError("Unhandled accumulator register.");
            }
        }
        ...
        void Capstone2LlvmIrTranslatorX86_impl::translateDaaDas(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
...

            {
                auto *alAdd = i->id == X86_INS_DAA
                              ...
                              : bodyIf.CreateAdd(al, llvm::ConstantInt::get(al->getType(),
                                                                            250)); // X86_INS_DAS, => +250 == -6
        ...
        void Capstone2LlvmIrTranslatorX86_impl::translateLoadFarPtr(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
            ...
            switch (i->id) {
                ...
                case X86_INS_LSS:
                    ...
                    break;
                default:
                    throw GenericError("Unhandled insn ID in translateLoadFarPtr().");
            }
 ...
 */
        void Capstone2LlvmIrTranslatorX86_impl::translateXlatb(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
            ...
            switch (xi->addr_size) {
                case 2:
                    ebx = loadRegister(X86_REG_BX, irb);
                    break;  // Maybe DS:BX?
                case 4:
                    ebx = loadRegister(X86_REG_EBX, irb);
                    break; // Maybe DS:EBX?
                case 8:
                    ebx = loadRegister(X86_REG_RBX, irb);
                    break; // Only RBX.
                default:
                    throw GenericError("Unhandled address size in XLATB.");
            }
 ...
 */
        void Capstone2LlvmIrTranslatorX86_impl::translateJecxz(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
            ...
            switch (xi->addr_size) {
                case 2:
                    ecx = loadRegister(X86_REG_CX, irb);
                    break;
                case 4:
                    ecx = loadRegister(X86_REG_ECX, irb);
                    break;
                case 8:
                    ecx = loadRegister(X86_REG_RCX, irb);
                    break;
                default:
                    throw GenericError("Unhandled addr size in translateJecxz().");
            }
        ...
        void Capstone2LlvmIrTranslatorX86_impl::translateLoop(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
            ...
            switch (xi->addr_size) {
                ...
                case 8:
                    ...
                    break;
                default:
                    throw GenericError("Unhandled addr size in translateLoop().");
            }
 ...
 */
        void Capstone2LlvmIrTranslatorX86_impl::translateJCc(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
            ...
            switch (i->id) {
                case X86_INS_JAE:
                    cond = generateCcAE(irb);
                    break;
                case X86_INS_JA:
                    cond = generateCcA(irb);
                    break;
                case X86_INS_JBE:
                    cond = generateCcBE(irb);
                    break;
                case X86_INS_JB:
                    cond = generateCcB(irb);
                    break;
                case X86_INS_JE:
                    cond = generateCcE(irb);
                    break;
                case X86_INS_JGE:
                    cond = generateCcGE(irb);
                    break;
                case X86_INS_JG:
                    cond = generateCcG(irb);
                    break;
                case X86_INS_JLE:
                    cond = generateCcLE(irb);
                    break;
                case X86_INS_JL:
                    cond = generateCcL(irb);
                    break;
                case X86_INS_JNE:
                    cond = generateCcNE(irb);
                    break;
                case X86_INS_JNO:
                    cond = generateCcNO(irb);
                    break;
                case X86_INS_JNP:
                    cond = generateCcNP(irb);
                    break;
                case X86_INS_JNS:
                    cond = generateCcNS(irb);
                    break;
                case X86_INS_JO:
                    cond = generateCcO(irb);
                    break;
                case X86_INS_JP:
                    cond = generateCcP(irb);
                    break;
                case X86_INS_JS:
                    cond = generateCcS(irb);
                    break;
                default:
                    throw GenericError("Unhandled insn ID in translateJCc().");
            }
        ...
        void Capstone2LlvmIrTranslatorX86_impl::translateSetCc(cs_insn *i, cs_x86 *xi, llvm::IRBuilder<> &irb) {
            ...
            switch (i->id) {
                ...
                case X86_INS_SETS:
                    ...
                    break;
                default:
                    throw GenericError("Unhandled insn ID in translateSetCc().");
            }
